      ...
      <div className="max-w-6xl w-full flex flex-col md:flex-row gap-8">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 flex-1">
          ...
          <p className="text-sm text-gray-700 mb-6">
            Your mental wellbeing matters. Our secure platform provides
            confidential access to support resources, counseling services, and
            wellness tools designed specifically for students.
          </p>
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 flex-1">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-600">
              Login to access your support resources
            </p>
          </div>
